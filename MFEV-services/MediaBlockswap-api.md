---
description: MFEV NetworkSwap API is an auxiliary service to ease the integration with MFEV NetworkSwap DEX
---

# MFEV Networkswap API

## MFEV Networkswap Backend API v0.1.0

The MFEV Networkswap Backend REST API is used for generating trading data for frontend clients

## PriceChange

### Get price change for token over last 24 hours

[Back to top](https://github.com/MFEV Networkio/MFEV Networkswap-service/blob/master/docs/api.md#top)
                        ...
                        "tokenAmounts": [
                            {
                                ...
                                "currency": {
                                    "decimals": 6,
                                    "symbol": "USDC",
                                    "name": "USD Coin on MFEV Network Coin",
                                    "chainId": 39656,
                            ...
                            },
                            {
                                ...
                                "currency": {
                                    "decimals": 18,
                                    "symbol": "WETH",
                                    "name": "Wrapped Ether on MFEV Network Coin",
                                    "chainId": 39656,
...
| Name       | Type       | Description                                                                                                |
| :--------- | :--------- | :--------------------------------------------------------------------------------------------------------- |
| methodName | `String`   | The method to call on MFEV Networkswap RouterV2                                                            |
